# Generated by Django 2.1.1 on 2018-09-03 08:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depart', models.ForeignKey(on_delete=True, to='crm.Department', to_field='code', verbose_name='部门')),
            ],
        ),
        migrations.AddField(
            model_name='customerdistrbute',
            name='consultant',
            field=models.ForeignKey(limit_choices_to={'depart_id': 1001}, on_delete=True, to='crm.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customerdistrbute',
            name='customer',
            field=models.ForeignKey(on_delete=True, related_name='customers', to='crm.Customer'),
        ),
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(limit_choices_to={'depart_id': 1001}, on_delete=True, related_name='consultanter', to='crm.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='course',
        ...
        migrations.AddField(
            ...
            name='teacher',
            field=models.ForeignKey(limit_choices_to={'depart_id__in': [1002, 1003]}, on_delete=True, to='crm.UserInfo', verbose_name='讲师'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='classlist',
            name='tutor',
            field=models.ForeignKey(limit_choices_to={'depart': 1001}, on_delete=True, related_name='classes', to='crm.UserInfo', verbose_name='班主任'),
        ),
    ]
